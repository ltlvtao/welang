...
func TestM9bSchedFIFO(t *testing.T) {
	compileAndRun(t,
		map[string]string{"gc.c": GCSource, "sched.c": SchedSource, "sched.h": SchedHeader, "main.c": schedFifoHarness},
		[]string{"gc.c", "sched.c", "main.c"},
		"a-start\nb-start\na-end\nb-end\njoined-a=0,0,42\n")
}

func TestM9bSchedTaskPanic(t *testing.T) {
	compileAndRun(t,
		map[string]string{"gc.c": GCSource, "sched.c": SchedSource, "sched.h": SchedHeader, "main.c": schedPanicHarness},
		[]string{"gc.c", "sched.c", "main.c"},
		"tag=1 msg=kapow\n")
}
...
func TestM9bSchedTimeout(t *testing.T) {
	compileAndRun(t,
		map[string]string{"gc.c": GCSource, "sched.c": SchedSource, "sched.h": SchedHeader, "conc.c": ConcSource, "main.c": schedTimeoutHarness},
...
func TestM9bSchedGcParkSurvival(t *testing.T) {
	compileAndRun(t,
		map[string]string{"gc.c": GCSource, "sched.c": SchedSource, "sched.h": SchedHeader, "conc.c": ConcSource, "main.c": schedGcParkHarness},
		[]string{"gc.c", "sched.c", "conc.c", "main.c"},
		"swept=0\nsurvived=7777\n")
}
...
func TestM9bSchedDeadlock(t *testing.T) {
	...
	for name, src := range map[string]string{
		"gc.c": GCSource, "sched.c": SchedSource, "sched.h": SchedHeader, "conc.c": ConcSource, "main.c": schedDeadlockHarness,
	} {
	...
	for _, in := range []string{"gc.c", "sched.c", "conc.c", "main.c"} {
